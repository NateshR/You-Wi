...
import com.example.you_wi.Get;
import com.example.you_wi.Main;
...
public final class CaptureActivity extends Activity implements
	...
	boolean handleOcrDecode(OcrResult ocrResult) {
		...
		basket.putString("input", ocrResultView.getText().toString());
		Intent i = new Intent(CaptureActivity.this, Get.class);
		i.putExtras(basket);
		startActivity(i);
		return true;
	}
